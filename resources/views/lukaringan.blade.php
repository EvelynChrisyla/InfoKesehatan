...
<body>
    <section class="about-section" id="">
        ...
        <img src="/img/CideraAsset1.png" class="CideraAsset1" style="float:right">
        <div>
                <h1>
                    <span class="black">Seputar</span>
                    <span class="red">Luka</span>
                    <span class="black">Ringan</span>
                    <span class="red">dan</span>
                    <span class="black">Cara</span>
                    <span class="red">Mengobatinya</span>
                </h1>
                <p>Luka ringan dapat terjadi ketika terjadi robekan pada permukaan kulit. Walaupun luka ringan adalah penyakit yang tidak serius, terbukanya kulit dapat
