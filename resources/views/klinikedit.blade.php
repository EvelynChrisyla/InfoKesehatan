...
@section('konten')
    ...
    <form action="{{ route('update.klinik', $klinik->id) }}" method="POST">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                <label for="diabetes" class="col-sm-2 col-form-label">Jumlah Bayi Laki-Laki</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='diabetes' id="diabetes" value="{{ $klinik->diabetes }}" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="dbd" class="col-sm-2 col-form-label">Jumlah Bayi Perempuan</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='dbd' id="dbd" value="{{ $klinik->dbd}}" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="covid" class="col-sm-2 col-form-label">Jumlah Bayi Stunting</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='covid' id="covid" value="{{ $klinik->covid}}" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="tbc" class="col-sm-2 col-form-label">Jumlah Bayi Normal</label>
                <div class="col-sm-10">
