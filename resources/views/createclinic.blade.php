...
<form action="{{ route('store.clinic') }}" method="POST">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='nomor_telepon' id="nomortelp">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <button type="submit" class="btn btn-primary" name="submit">Tambah Klinik</button>
            </div>
        </div>
    </div>
</form>
