...
<form action="{{ route('store.klinik') }}" method="POST">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            <label for="diabetes-diabetes" class="col-sm-2 col-form-label">Jumlah Bayi DBD-DBD</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='diabetes' id="diabetes-diabetes" required>
            </div>
        </div>
        <div class="mb-3 row">
            <label for="dbd" class="col-sm-2 col-form-label">Jumlah Bayi DBD</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='dbd' id="dbd" required>
            </div>
        </div>
        <div class="mb-3 row">
            <label for="covid" class="col-sm-2 col-form-label">Jumlah Bayi covid</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='covid' id="covid" required>
            </div>
        </div>
        <div class="mb-3 row">
            <label for="tbc" class="col-sm-2 col-form-label">Jumlah Bayi tbc</label>
            <div class="col-sm-10">
